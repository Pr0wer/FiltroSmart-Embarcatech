...
// Desenha um frame MATRIZ_ROWSxMATRIZ_COLS no buffer da matriz de LED com a cor desejada
void desenharFrame(const uint8_t frame[MATRIZ_ROWS][MATRIZ_COLS], uint8_t r, uint8_t g, uint8_t b)
{
